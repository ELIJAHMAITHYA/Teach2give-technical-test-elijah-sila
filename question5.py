...
def has_2_consecutive_threes(value):
    return any(value[i] == 3 and value[i + 1] == 3 for i in range(len(value) - 1))


# example
print(has_2_consecutive_threes([1, 3, 3]))
print(has_2_consecutive_threes([1, 3, 1, 3]))
